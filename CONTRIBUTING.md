# Contributing to AumAI Openjudge
...
### Setup
```bash
git clone https://github.com/aumai/aumai-openjudge.git
cd aumai-openjudge
python -m venv .venv
...
### Good First Issues
New to the project? Start with issues labeled [`good first issue`](https://github.com/aumai/aumai-openjudge/labels/good%20first%20issue).
...
- [GitHub Discussions](https://github.com/aumai/aumai-openjudge/discussions)
